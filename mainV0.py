...
def main():
    ...
    # Upload the cleaned DataFrame to SharePoint
    ...
    #client_id = os.getenv('CLIENT_ID')
    #client_secret = os.getenv('CLIENT_SECRET')
    upload_dataframe_to_sharepoint_folder(site_url, old_pfp_folder, output_file_name, cleaned_df, client_id, client_secret)
